---
title: Changelogs
description: Bot's changelogs and version history
---
...
- Learn more about linked roles [here](/docs/guides/linked-role).
- Learn how to enable linked roles [here](/docs/guides/linked-role).
- Learn how to get linked roles [here](/docs/guides/linked-role).
...
- Added documentations for command to explain it's uses, with examples ([Docs](/docs/commands))
...
- Some general improvements in Daily Quests embed
...
You can help translate [here](/docs/guides/translating)
...
- **`/guides`**: Merged with `seasonal-guides` and now includes a `realms` subcommand for realm-based guides. An `events` guide is also planned for future addition.
