...
And video preview showcasing some of it's capabilities.

<VideoPreview src="/screenshots/planner/planner-preview.mp4" thumbnail="/screenshots/planner/planner-wls.png" />
