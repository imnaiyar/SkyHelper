...
<Callout type="warn">
  Since guides are created by humans, they may occasionally be posted later than usual or not at all. The bot typically has a 1-2
  hour grace period after reset for guides to appear.
</Callout>
...
<Callout type="info">
  **Check After Reset**: The first thing to check each day is the daily quests guide. It helps you plan your entire candle run
  efficiently.
</Callout>
