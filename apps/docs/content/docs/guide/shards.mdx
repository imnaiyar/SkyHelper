...
**Commands**: `/shards`, `/shards-calendar`
...
- **Full day schedule** - All times the shard appears throughout the day
  ...
  <Gallery
    images={[
      { url: "/screenshots/shards-main.png", alt: "Shards" },
      { url: "/screenshots/shards-timeline.png", alt: "Shards Timeline" },
    ]}
  />
...
- Visual layout making it simple to plan your shard collection
  ...
  <Gallery
    images={[
      { url: "/screenshots/shards-calendar.png", alt: "Shards Calendar" },
      { url: "/screenshots/shards-calendar-month-year.png", alt: "Shards Calendar Change Month/Year" },
    ]}
  />
