---
title: Event Datas
description: TypeScript API documentation for eventDatas
---
...
/\*_ The index of the event to appear on the embed _/

index: number;

/\*_ The Offset of the event (in minutes) _/
offset: number;

/\*_ Approximate duration of the event during which its active after it starts (in minutes) _/
duration?: number;

/\*_ The interval at which the event occurs (in minutes) _/
interval?: number;

/\*_ Whether to display all their occurrence times in the embed _/
