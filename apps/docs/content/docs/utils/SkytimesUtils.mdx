---
title: Skytimes Utils
description: TypeScript API documentation for SkytimesUtils
---
...
/\*_ The time when the event starts _/
nextTime: DateTime;
...
/\*_ The time when the event ends if active _/
endTime?: DateTime;
}
