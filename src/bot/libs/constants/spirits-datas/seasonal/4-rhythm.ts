...
const data: Record<string, SpiritsData> = {
  juggler: {
    ...
    tree: {
      ...
      image: "Troupe_Juggler_Tree_Clement.png.jpg",
    },
    location: {
      by: "Clement",
  ...
  director: {
    ...
    ts: {
      eligible: true,
      returned: true,
      dates: ["June 20, 2024 (#116)", ["July 03, 2023 (SV#3)", "July 16, 2023"], "July 08, 2022 (#67)", "May 13, 2021 (#35)"],
    },
    tree: {
      by: "Jed",
  ...
  pianist: {
    ...
    ts: {
      eligible: true,
      returned: true,
      dates: [["July 03, 2023 (SV#3)", "July 16, 2023"], "February 04, 2021 (#28)"],
    },
    tree: {
      by: "Jed",
