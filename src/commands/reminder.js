    ...
    try {
      ...
      if (customId === "reminders-edit-channel") {
        ...
        if (!ch.permissionsFor(int.guild.members.me.has('ManageWebhooks'))) {
          return await int.editReply('I do not have `Manage Webhooks` permission in ${ch}. Please make sure thay there is not channel level permissions overwride and if there is, please grant me the necessary permissions in the said channel before running the command again.');
        }
