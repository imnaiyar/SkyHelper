...
module.exports = {
    ...
    async execute(interaction) {
      ...
      if (input && interaction.guild && input > 10) {
        return interaction.reply({content: `Max number is 10 to prevent clogging up the channel, you provided \`${input}\`. Run the command in my dm for upto 15 results.`, ephemeral: true})
      }
      if (input && input > 15) {
        return interaction.reply({content: `Max number is 15. You provided \`${input}\``, ephemeral: true})
      }
