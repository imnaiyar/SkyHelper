...
async function Guides(interaction) {
 ...
 const reply = await interaction.reply({
  ...
  if (i.user.id !== interaction.user.id) {
    i.reply({ content: 'You can\'t use the menu generated by others. Run the command </seasonal-guides:1147244751708491897> if you wish to use it.', ephemeral: true});
    return false; 
  }
 return i.isStringSelectMenu() && i.message.id === reply.id;
};
