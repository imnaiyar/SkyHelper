...
export default {
    data: {
        ...
        description_localizations: x(
            "commands.SEASONAL_CALCULATOR.description"
        ),
        ...
        options: [
            {
                name: "candles",
                name_localizations: x(
                    "commands.SEASONAL_CALCULATOR.options.CANDLES.name"
                ),
                description: "amount of candles you have?",
                description_localizations: x(
                    "commands.SEASONAL_CALCULATOR.options.CANDLES.description"
                ),
                required: true,
            ...
            },
            {
                name: "dailies",
                name_localizations: x(
                    "commands.SEASONAL_CALCULATOR.options.DAILIES.name"
                ),
                description: "did you do your dailies today?",
                description_localizations: x(
                    "commands.SEASONAL_CALCULATOR.options.DAILIES.description"
                ),
                required: true,
            ...
            },
            {
                name: "season-pass",
                name_localizations: x(
                    "commands.SEASONAL_CALCULATOR.options.SEASON_PASS.name"
                ),
                description: "do you have the season pass?",
                description_localizations: x(
                    "commands.SEASONAL_CALCULATOR.options.SEASON_PASS.description"
                ),
                required: false,
                type: ApplicationCommandOptionType.Boolean
            }
