 ...
 * @param {import('moment').Moment} givenDate
 * @returns
 */
function shardsReply(givenDate) {
  const { eventStatus, timeRemaining, currentShard, currentRealm, dayOfWeek, noShard } = shardsAlt(givenDate);
