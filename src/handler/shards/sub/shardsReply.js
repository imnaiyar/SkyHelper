...
const messageDataFile = 'messageData.json';
    ...
    .setAuthor({ name: `Shards Information for ${noShard}`, iconURL: 'https://media.discordapp.net/attachments/888067672028377108/1124426967438082058/SOShattering-radiant-shards.jpg?width=862&height=925'})
    .setTimestamp(Date.now())
    .setFooter({ text: 'SkyHelper', iconURL: interaction.client.user.displayAvatarURL() });
...
if (showButtons) {
  ...
  result.setImage('https://media.discordapp.net/attachments/867638574571323424/1155727524911923220/5F1548AC-C7DD-4127-AF6F-0BC388-unscreen.gif').setDescription(`**It's a no shard day.**`).setColor('#9fb686')
