module.exports = {
  ...
  b: [
    {
      title: '1st Shard',
      earlySky:
        'Sky colour of all the realm changes once the shard nears landing. These changes happen **1 hours**, **37 minutes** and **50 seconds** after reset\nYour time: <t:1686127070:T>',
      gateShard:
  ...
  A: [
    {
      title: '1st Shard',
      earlySky:
        'Sky colour of all the realm changes once the shard nears landing. These changes happen **1 hours**, **47 minutes** and **50 seconds** after reset\nYour time: <t:1686127670:T>',
      gateShard:
  ...
  a: [
    {
      title: '1st Shard ',
      earlySky:
        'Sky colour of all the realm changes once the shard nears landing. These changes happen **1 hours**, **17 minutes** and **50 seconds** after reset\nYour time: <t:1686125870:T>',
      gateShard:
        'Shard crystals on realm doors indicating their location. They appear **1 hours** and **50 minutes** after reset.\nYour time: <t:1686127800:t>',
      shardLand:
        '1st shard lands **1 hours**, **58 minutes** and **40 seconds** after reset\nYour Time: <t:1686128320:T>',
      shardEnd:
  ...
  B: [
    ...
    },
    {
      ...
      shardLand:
        '1st shard lands **9 hours**, **38 minutes** and **40 seconds** after reset\nYour Time: <t:1686155920:T>',
      shardEnd:
