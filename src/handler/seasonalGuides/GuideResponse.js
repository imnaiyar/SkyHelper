...
module.exports = {
  ...
  // shattering
    // shattering quests
    'shattering_q': {
      content: "<:shattering:1130961257097334895>There are some changes to Shattering quests post-season.\nTo complete the quest, you'll have to complete a red shard event. To find out what shard is today you can run the command \`/shards\` to find its type, location and what time it falls. You can also provide an optional date to look ahead for red shards if it's not available today. Alternatively,  you can also use this Shards tracker website by Plutoy: https://sky-shards.pages.dev/.\n\nOnce you complete a red shard, you can do the activity after which you get your rewards (You can only get the rewards one time for a particular day), Void of Shattering will appear, click on it to teleport to the Void. \nTalk to the Void guide to activate further quests, and repeat the same process to complete the rest of the quests. You can do multiple red shards a day to complete the quests.\n\nEach quest has a different memory, and each memory has a winged light. \n\nNote: Once you have completed all Shattering quests, the next time when you complete a red shard event, the memory you'll get will be completely random. You won't be able to jump to a different memory. For each red shard day, there is a single random memory.\n\n**__Relevent Links__**\nAll about Shards by Nami: https://discord.com/channels/575762611111592007/585339436322259003/998518828055154728\n\nTips on how to SOLO the Shard quests by StarDream: https://discord.com/channels/575762611111592007/575827924343848960/996129498783293490\n\nFinding Shard events using in-game cues by Adome: https://discord.com/channels/575762611111592007/585339436322259003/996267192205201408\n\nCompilation of Shattering seasonal guides by Clement: https://discord.com/channels/575762611111592007/575827924343848960/995967135329308672\n\nFAQs about Shards by Nami: https://discord.com/channels/575762611111592007/585339436322259003/998520119330357298\n\n```Season of Shattering quest guide by Clement```",
