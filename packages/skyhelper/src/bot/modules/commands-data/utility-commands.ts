    ...
    options: [
...

      {
        ...
        options: [
          {
            name: "action",
            name_localizations: "commands:PLANNER.options.action.name",
            description_localizations: "commands:PLANNER.options.action.description",
            description: "the action you want to perform",
            type: ApplicationCommandOptionType.String,
            required: true,
            choices: [
              { name: "Import Data", value: "import", name_localizations: "commands:PLANNER.options.choices.import" },
              { name: "Export Data", value: "export", name_localizations: "commands:PLANNER.options.choices.export" },
              { name: "Delete Data", value: "delete", name_localizations: "commands:PLANNER.options.choices.delete" },
            ],
          },
        ],
      },
