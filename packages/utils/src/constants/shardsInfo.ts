...
export const shardsInfo: ShardsInfo = {
  prairie: {
    a: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1053249686422687784/dp-b_Butterfly_Field.png",
    },
    A: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1044197796577824839/dp-r_Bird_Nest.png",
    },
    b: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1049635543421550652/dp-b_Village-Koi.png",
    },
    B: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1051464559065583637/dp-r_Sanctuary_Islands.png",
    },
    C: {
      ...
      data: "https://media.discordapp.net/attachments/1123347180988661902/1126113425286766702/dp-r_Caves.jpg",
    },
  },
  ...
  forest: {
    a: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1051802895634399242/hf-b_Forest_Brook.png",
    },
    A: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1046371999586451597/png_20221027_180854_0000.png",
    },
    b: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1048189111145603072/hf-b_Boneyard.png",
    },
    B: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1053645676870897724/hf-r_Elevated_Clearing.png",
    },
    C: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1050078656015376496/hf-r_Forest_End.png",
    },
  },
  valley: {
    a: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1050351219383730186/vt-b_Ice_Rink.png",
    },
    A: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1048546903702384721/vt-r_Village_of_Dreams.png",
    },
    b: {
      area: "Ice Rink, <:r3Valley:1150596376930037850> Valley of Triumph",
      rewards: "200 Wax <:wax:1125091974869946369>",
    ...
    B: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1055814361026936952/vt-r_Hermit_Valley.png",
    },
    C: {
      area: "Village of Dreams, <:r3Valley:1150596376930037850> Valley of Triumph",
      rewards: "2.5 AC <a:ac5:1125338720183267390>",
  ...
  wasteland: {
    a: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1045297714474254396/gw-b_Broken_Temple.png",
    },
    A: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1050722076681568256/gw-r_Shipwreck.png",
    },
    b: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1052530499668688957/gw-b_Battlefield.png",
    },
    B: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1069221627918827622/Forgotten_Ark_1.png",
    },
    C: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1043553879289253919/gw-r_Graveyard.png",
    },
  },
  vault: {
    a: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1077178980051984455/vk-b_Starlight_Desert.png",
    },
    A: {
      ...
      data: "https://media.discordapp.net/attachments/575827924343848960/1049290746190106694/vk-r_Starlight_Desert.png",
    },
    b: {
      area: "Starlight Desert, <:r1Vault:1150596447679553636> Vault of Knowledge",
      rewards: "200 Wax <:wax:1125091974869946369>",
